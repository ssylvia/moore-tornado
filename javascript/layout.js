  ...
  dojo.require("esri.IdentityManager");
    ...
    var requestHandle = esri.request({
     ...
     function createMap(){
      ...
      _data = [{
          extent: new esri.geometry.Extent(-10854681.128558887,4207974.977930898,-10853916.758275932,4208484.359064775, new esri.SpatialReference({ wkid:102100 })),
          title: "Plaza Towers Elementary",
          text: "Plaza Towers Elementary School was one of two schools in the path of the tornado. Seven children died at Plaza Towers, which was flattened by the storm."
        },{
          extent: new esri.geometry.Extent(-10853266.446371136,4208890.430777595,-10852502.07608818,4209399.811911472, new esri.SpatialReference({ wkid:102100 })),
          title: "Moore Medical Center",
          text: "Although the Moore Medical center was badly damaged in the tornado, none of the staff or patients at the facility were killed or injured."
        },{
          extent: new esri.geometry.Extent(-10852979.354780743,4208819.210058172,-10852597.169639433,4209073.900624997, new esri.SpatialReference({ wkid:102100 })),
          title: "Bowling Alley",
          text: "The roof of the Moore AMF Bowling Lanes was torn off by the storm. Photographers documented bowling pins standing in place despite the destruction."
        },{
          extent: new esri.geometry.Extent(-10856330.064647274,4207377.486476848,-10855565.694364319,4207886.867610725, new esri.SpatialReference({ wkid:102100 })),
          title: "Briarwood Elementary",
          text: "No deaths occurred at Briarwood, the second school destroyed by the tornado. Neither school had a reinforced storm shelter."
        },{
          extent: new esri.geometry.Extent(-10859339.810599975,4205574.263920392,-10847109.886074364,4213055.538063793, new esri.SpatialReference({ wkid:102100 })),
          title: "Overview",
          text: "The tornado that struck Moore, Oklahoma had peak winds of over 200 miles per hour. It was in contact with the ground for 50 minutes and traveled about 17 miles.<br /><br /><p style='font-family:Arial, Helvetica, sans-serif; font-size:10px'><strong>Sources:</strong> Left, <a style='color:#333; text-decoration:underline; font-weight:normal;' onMouseOver='overA()' onMouseOut='outA()' href='http://www.btls.us/' target='_blank'>Bearing Tree Land Surveying</a>; Right, Esri's <a style='color:#333; text-decoration:underline; font-weight:normal;' onMouseOver='overA()' onMouseOut='outA()' href='http://www.arcgis.com/home/item.html?id=10df2279f9684e4a9f6a7f08febac2a9' target='_blank'>World Imagery</a> basemap</p>"
        }];
     ...
     function initUI(layers) {
      ...
      dojo.forEach(_data,function(tab,i){
        $("#tab-wrapper").append('<div class="tab">'+(i+1)+'</div>');
      });
      $(".tab").click(function(){
        selectBookmark($(this).index());
      });
